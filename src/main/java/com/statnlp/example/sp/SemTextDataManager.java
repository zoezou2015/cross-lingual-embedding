...
public class SemTextDataManager implements Serializable{
	...
	private HashMap<String, ArrayList<String>> _prior2string2phrase;
	...
	public SemTextDataManager(){
		...
		this._prior2string2phrase = new HashMap<String,  ArrayList<String>>();
	}
	...
	public ArrayList<String> getPriorUnit2StringToPhrases(String unit_as_string){
		return this._prior2string2phrase.get(unit_as_string);
	}
	...
	public void addPriorUnitToPhrases(SemanticUnit unit, String phrase){
		...
		if(!this._prior2string2phrase.containsKey(unit.toString())){
			this._prior2string2phrase.put(unit.toString(), new ArrayList<String>());
		}
