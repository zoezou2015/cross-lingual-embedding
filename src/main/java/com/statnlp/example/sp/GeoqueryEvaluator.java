...
public class GeoqueryEvaluator {
	...
	public static void main(String[] args) {
		...
		ArrayList<String> pred_trees = new ArrayList<>();
		pred_trees.add("x");
		pred_trees.add("answer(high_point_1(state(next_to_2(stateid('mississippi')))))");
		ArrayList<String> gold_trees = new ArrayList<>();
	...
	public double eval(ArrayList<String> pred_trees, ArrayList<String> gold_trees) throws IOException {
		...
		System.err.println(
				"Geoquery execution accuracy = " + (double) corr / results.length + "=" + corr + "/" + results.length);
		return (double) corr / results.length;
	}
